	...
	<div id="Wrapper">
		...
		<div id="Container">
			<div id="Contents">
				...
				<ul class="infor-data">
					<li><span>주문일자&nbsp;&nbsp;:</span> <strong>${buylist.buydate }</strong>
					</li>
					<li><span>주문번호&nbsp;&nbsp;:</span> <strong>${buylist.buynum }</strong>
				...
				<table class="board-list-2s">
					...
					<tbody class="history3">
						<tr>
							<td class="subject">
								<div class="area">
									<a class="thum"
										href="#제품페이지이동">
										<img
										src="${buylist.img_main}"
										alt="${buylist.product_subname }"
							...
							<td class="colorBlack"><strong>${buylist.product_price}</strong> 원</td>
							<td>${buylist.product_count}</td>
							<td class="colorOrange"><strong>${buylist.product_price * product_count }</strong> 원</td>
							<!-- <td class="bgnone">취소완료 <span class="color1sSize">처리일시<br>2019.08.09 -->
							</span>
				...
				<table class="board-write-2s view">
					...
					<tbody>
						<tr>
							<th scope="row">받는분</th>
							<td colspan="3">${buylist.delivery_name }</td>
						</tr>
						<tr>
							<th scope="row">연락처1</th>
							<td colspan="3">${buylist.delivery_mtel}</td>
						</tr>
						<tr class="addr">
							<th scope="row">주소</th>
							<td colspan="3">
								<span class="data">${buylist.delivery_address}</span>
							</td>
						</tr>
					</tbody>
				</table>
				...
				<div class="price-conts">
					<ul class="list ">
						<li>
							...
							<ul>
								<li><span class="txt">총 상품금액</span> <span class="won">114,300<em>원</em></span>
								</li>
								<li><span class="txt">총 배송비</span> <span class="won">0<em>원</em></span>
								</li>
							</ul>
						</li>
						<li>
					...
					<div class="price-sum">
						<div>
							<strong>총 결제금액</strong><span>114,300<em>원</em></span>
						</div>
