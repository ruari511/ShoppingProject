<%@page import="buyList.BuyListDAO"%>
				...
				<div class="mypage-conts">
					...
					<table class="board-list-2s mgT20">
						...
						<tbody class="history">
								...
								<tr>
								<td rowspan="1">
									<%-- <span style="display: inline-block; font-weight: bold;">${buylist.buytime }</span> --%><!-- 주문일  -->
									<span class="color1s">${buylist.buynum }</span><!-- 주문번호  -->
									<%-- <a class="btnDetail" href="getOrderDetail.do?buynum=${buylist.buynum }">주문상세보기</a>  --%>
								</td>
								<td class="subject ">
								
									<div class="area">
										<a class="thum" href="제품페이지이동링크"> <!-- 제품상세페이지 이동  -->
											<img src="#"
											alt=" " onerror="common.errorImg(this);"> <!-- 제품이미지 정보 -->
										</a>
										<div class="textus">
											<a class="" href="제품페이지이동링크">
								...
								<td class="">${buylist.product_count }</td> <!-- 제품 구매 수량 -->
								<td class="colorOrange">${buylist.product_price }원</td> <!-- 총 구매가  -->
								<td><strong>배송완료</strong>
									<button type="button" class="BtnDelete mgT5">
</button>
