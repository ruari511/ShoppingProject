...
<div id="Wrapper">
	<div id="Container">
		<div id="Contents">	
			...
			<tbody>
				<form id="" action="./BoardNoticeWriteAction.bd" method="POST">
					<tr>
						...
						<td>
							<select id="category" name="category" title="문의유형 항목을 선택하세요" style="width:192px;">
								...
								<option value="20" >매장</option>
								<option value="30" >이벤트</option>
								<option value="40" >뷰티테스터</option>
							</select>
						</td>
					</tr>
					<tr class="textarea">
						...
						<td>
							<input required type="text" id="subject" name="subject" placeholder="제목을 입력해주세요.(2000자 이내)" style="width:98%;"></input>
						</td>
					</tr>
					<tr>
