...
<head>
	...
	$(window).ready(function(){
			...
			$('input[name=search_id]').keyup(function(){
				...
				<div class="mypage-conts">
					...
					<fieldset class="search-period">
						...
						<ul class="select-month">
							<li><button type="button"  onclick="location.href ='mypage_Order_manager.mp?data_month=-1'">1개월</button></li>
							<li><button type="button"  onclick="location.href ='mypage_Order_manager.mp?data_month=-3'">3개월</button></li>
							<li><button type="button"  onclick="location.href ='mypage_Order_manager.mp?data_month=-6'">6개월</button></li>
							<li><button type="button"  onclick="location.href ='mypage_Order_manager.mp?data_month=-12'">12개월</button></li>
						</ul>
					...
					<table class="board-list-2s mgT20">
						...
						<thead>
							<tr>
								<th colspan="4"></th>
								<th>
									<input type="text" name="search_id" placeholder="아이디를입력하세요" style="height: 25px; width: 150px;"></input>
								</th>
								<th>
									<button type="button" onclick="search_id()">검색</button>
						...
						<tbody class="history">
							...
							<c:if test="${!empty buylist}">
								<c:forEach var="buylist" items="${buylist}">
										...
										<td>
											<select name="delivery_result" title="배송 상태 선택" style="width:70px;">
										...
										<td class = "gubun">
											${buylist.id } <br>${buylist.order_name }
										</td>
									</tr>	
								</c:forEach>
							</c:if>
